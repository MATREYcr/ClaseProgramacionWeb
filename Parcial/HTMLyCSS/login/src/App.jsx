  ...
  return (
    <>
      <div className=" w-screen h-screen flex">
        <div className=" h-full w-[40vw] flex justify-end items-center bg-GreenContainer overflow-hidden">
          <div className="w-full sm:w-[20vw] h-[80vh] shadow-max flex flex-col justify-center items-center box-border p-2">
            <img className=" max-w-[62%] mb-4" src="/puma1.png" alt="logo" />
            <div className="flex justify-center items-center sm:max-w-[62%]">
              <p className=" text-start font-medium ">
                {" "}
                India first waterless car cleaning company
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="w-full sm:w-[40vw] h-[80vh] shadow-max flex flex-col justify-start items-center">
            ...
            <div className=" h-full w-full flex flex-col justify-center items-center">
              ...
              <div className="w-2/3">
                ...
                <button className="w-full p-2 rounded-lg bg-GreenContainer font-medium mt-12">
                  Login
                </button>
              </div>
            </div>
